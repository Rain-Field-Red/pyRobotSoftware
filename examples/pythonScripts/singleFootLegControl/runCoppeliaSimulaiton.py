...
def main():
    ...
    ankle_joint_handle = mainProcess.m_jointHandle[2]
    ...
    ankle_angle, ankle_angle_dot = mainProcess.simGetJointInfo(ankle_joint_handle)
    pid_hip = PID(1000,0,200,(hip_angle))                      #期望设置到当前
    pid_knee = PID(700,0,150,(knee_angle))
    pid_ankle = PID(200,0,50,(ankle_angle))
    ...
    plt.plot(time_hidtory,ankle_joint_history,'r-')
    plt.show()
